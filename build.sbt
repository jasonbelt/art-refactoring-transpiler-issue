...
//     Right click src/main/architecture/packageName_not_set/Demo.scala and choose "Run 'Demo'"
//
...
val slangEmbeddedSettings = Seq(
  ...
  mainClass in (Compile, run) := Some("packageName_not_set.Demo"),

  mainClass in assembly := Some("packageName_not_set.Demo"),
...
val slangEmbeddedInspectorSettings = Seq(
  ...
  mainClass in (Compile, run) := Some("packageName_not_set.InspectorDemo"),
)
