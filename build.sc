...
//   $SIREUM_HOME/bin/mill packageName_not_set.run
//
// To run the example unit tests:
//   $SIREUM_HOME/bin/mill packageName_not_set.tests
//
// Sireum IVE:
//   First cd to the directory containing this file and execute the following:
//
//     $SIREUM_HOME/bin/sireum tools ivegen -f -m mill -n building_control_gen_mixed--Linux ../
//
...
//
//     $SIREUM_HOME/bin/mill -w packageName_not_set.tests.compile
//
// Visual Studio Code:
...
object `packageName_not_set` extends slangEmbeddedProject
...
trait SlangEmbeddedModule extends ScalaModule {
  ...
  // https://github.com/sireum/scalac-plugin/tree/4.20210430.5b98e6e
  val sireumScalacVersion = "4.20210430.5b98e6e"
  ...
  override def mainClass = T { Some("packageName_not_set.Demo") }
...
trait slangEmbeddedInspectorProject extends slangEmbeddedProject {
  ...
  override def mainClass = T { Some("packageName_not_set.InspectorDemo") }
