...
object Arch {
  val BuildingControlDemo_i_Instance_tcp_tempSensor : packageName_not_set.BuildingControl.TempSensor_i_tcp_tempSensor_Bridge = {
    ...
    packageName_not_set.BuildingControl.TempSensor_i_tcp_tempSensor_Bridge(
      id = 0,
  ...
  val BuildingControlDemo_i_Instance_tcp_tempControl : packageName_not_set.BuildingControl.TempControl_i_tcp_tempControl_Bridge = {
    ...
    packageName_not_set.BuildingControl.TempControl_i_tcp_tempControl_Bridge(
      id = 1,
  ...
  val BuildingControlDemo_i_Instance_tcp_fan : packageName_not_set.BuildingControl.Fan_i_tcp_fan_Bridge = {
    ...
    packageName_not_set.BuildingControl.Fan_i_tcp_fan_Bridge(
      id = 2,
